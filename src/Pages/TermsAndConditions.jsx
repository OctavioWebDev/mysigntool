...
const TermsAndConditions = () => (
    <div className="flex flex-col min-h-screen">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 mt-10">
        <div className="space-y-4 text-sm max-w-4xl mx-auto">
        
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/relaxed text-transparent bg-clip-text bg-gradient-to-r from-purple-900 to-blue-700">
                    Terms & Conditions
                    </h2>
                <p className="max-w-[900px] md:text-xl dark:text-gray-400">
                ...
                <h3 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/relaxed text-transparent bg-clip-text bg-gradient-to-r from-purple-900 to-blue-700">
                    Use of Our Website
                    </h3>
                <p className="max-w-[900px] md:text-xl dark:text-gray-400">
                    ...
                    <section className="w-full py-12 md:py-24 lg:py-32 border-t bg-gray-800">
                    <div className="space-y-4 text-sm max-w-4xl mx-auto">
                <h3 className="text-2xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none text-transparent bg-clip-text bg-gradient-to-r from-purple-900 to-blue-700">
                ...
                <p className="max-w-[900px] md:text-xl dark:text-gray-400">
                    ...
                    <section className="w-full py-12 md:py-24 lg:py-32 bg-transparent border-t">
                    <div className="space-y-4 text-sm max-w-4xl mx-auto">
                <h3 className="text-2xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none text-transparent bg-clip-text bg-gradient-to-r from-purple-900 to-blue-700">
